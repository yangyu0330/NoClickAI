...
The audit checks `/health`, the public review pages, the downloads page, authenticated readiness, a safe KakaoTalk share-fallback automation run, and account deletion cleanup using a temporary account.
